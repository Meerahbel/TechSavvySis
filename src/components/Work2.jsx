const Work2 = ({ handleMouseout, handleOver, boxHover }) => {
  return (
    <div
      id="box2"
      onMouseOver={() => handleOver("box2")}
    ...
    >
        ...
        {boxHover === "box2" && (
          <div className="bg-[#ec4899]/30 absolute left-0 top-0 w-full h-full flex items-center spread">
            <div className="w-[150px] h-[130px] bg-[#ec4899]/50 mx-auto border-2 border-[#ec4899] rounded-md flex flex-col items-center justify-center gap-2 rush">
              ...
              <a
                href="https://getlinked-ten-mocha.vercel.app/"
                target="/"
                className="w-fit"
              >
      ...
      <p className="text-[#ec4899] font-semibold py-2">Getlinked</p>
      <p className="text-[#a6aec2]">A landing page for a tech hackathon.</p>
      <a
        href="https://github.com/Meerahbel/Getlinked"
        target="/"
