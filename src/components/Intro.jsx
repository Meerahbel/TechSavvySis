      ...
      <section className="flex flex-col gap-10">
        <div className="flex flex-col font-bold z-[999]">
          <p
            ...
            className="pr-2 text-white text-[4rem] md:text-[4rem] lg:text-[5rem] leading-tight"
          >
            Mirabel..
          </p>
          <p
            ...
            data-aos-duration="2000"
            data-aos-delay="300"
            className="pr-2 text-white text-[2.5rem] md:text-[4rem] lg:text-[5rem]"
          >
            Frontend Developer
          </p>
          <p
            ...
            data-aos-duration="2000"
            data-aos-delay="500"
            className="text-[#ec4899] text-[1.5rem] md:text-[2rem] w-[80%] md:w-full"
          >
